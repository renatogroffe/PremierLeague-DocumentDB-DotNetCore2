    ...
    public class PaginaClassificacao
    {
        ...
        public void CarregarPagina()
        {
            ...
            _driver.Navigate().GoToUrl(
                _configurations.UrlPaginaClassificacaoPremierLeague);
        }
        ...
        public Classificacao ObterClassificacao()
        {
            ...
            classificacao.id = $"Premier League {DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}";
            classificacao.NomeCampeonato = "Premier League";
